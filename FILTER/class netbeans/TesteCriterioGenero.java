...
public class TesteCriterioGenero {
     ...
     public static void main(String[] args) {
          ...
          criterio = new MulheresSolteiras();

          List<Individuo> MulheresSolterias = criterio.atendeCriterio(listaIndividuo);

          for (Individuo mulherSolteira : MulheresSolterias) {
               System.out.println("Nome: " + mulherSolteira.getNome()
                   + " Genero: " + mulherSolteira.getGenero()
                   + "  Estado Civil: " + mulherSolteira.getEstadoCivil());
          }
